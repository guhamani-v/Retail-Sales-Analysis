...
End-to-end Retail Sales Analysis project using the Superstore dataset to uncover business insights through SQL, Excel, and Power BI.
...
- Which product categories have the highest number of returned orders?
...
- Basic business reporting using SQL.

---

## Sprint 2 – Customer Analysis
...
## Sprint 3 – Business Analysis
- Business problem-solving using SQL.
- CASE statement implementation.
- Product profitability analysis.
- Regional and category performance analysis.
- Sales classification and reporting.

---

## Sprint 4 – Sales Ranking Analysis
- Sales ranking using Window Functions.
- Top-N product and customer analysis.
- Business performance ranking.
- ROW_NUMBER(), RANK(), and DENSE_RANK() implementation.

---

## Sprint 5 – Multi-Table Analysis
- Business analysis using SQL joins.
- Multi-table analysis with Orders, Returns, and People tables.
- Regional Manager performance analysis.
- Returned orders analysis across categories and regions.
